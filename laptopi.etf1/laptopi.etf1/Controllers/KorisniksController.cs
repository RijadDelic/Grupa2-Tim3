...
namespace laptopi.etf1.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("korisnikID,ime,prezime,email,sifra,uloga,datumRegistracije,akrivan")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("korisnikID,ime,prezime,email,sifra,uloga,datumRegistracije,akrivan")] Korisnik korisnik)
        {
